...
import CreateRestaurantCategorieScreen from './CreateRestaurantCategoryScreen'
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        ...
        <Stack.Screen
        name='CreateRestaurantCategorieScreen'
        component={CreateRestaurantCategorieScreen}
        options={{
